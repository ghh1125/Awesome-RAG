...
- [TimeR$^4$ : Time-aware Retrieval-Augmented Large Language Models for Temporal Knowledge Graph Question Answering](https://aclanthology.org/2024.emnlp-main.394.pdf)
...
- [LONG$^{2}$RAG: Evaluating Long-Context & Long-Form Retrieval-Augmented Generation with Key Point Recall](https://aclanthology.org/2024.findings-emnlp.279.pdf)
...
- [R$^2$AG: Incorporating Retrieval Information into Retrieval Augmented Generation](https://aclanthology.org/2024.findings-emnlp.678.pdf)
